...
#import "UIView+FJAdditions.h"

#define KEY_FJ_ALERT_VIEW "UIView.AlertController"

@implementation UIView (FJHUD)
@dynamic alertController;

-(UIAlertController *)alertController{
    NSObject * obj = objc_getAssociatedObject(self, KEY_FJ_ALERT_VIEW);
...
-(void)setAlertController:(UIAlertController *)alertController
{
    ...
    objc_setAssociatedObject(self, KEY_FJ_ALERT_VIEW, alertController, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}
