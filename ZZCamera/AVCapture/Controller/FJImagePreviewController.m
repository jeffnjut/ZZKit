...
- (void)_buildUI {
    ...
    [btnBack setImage:@"FJImagePreviewController.btn_camera_back".zz_image forState:UIControlStateNormal];
    [btnBack setImage:@"FJImagePreviewController.btn_camera_back".zz_image forState:UIControlStateHighlighted];
    ...
    [btnTake setImage:@"FJImagePreviewController.btn_camera_complete".zz_image forState:UIControlStateNormal];
    [btnTake setImage:@"FJImagePreviewController.btn_camera_complete".zz_image forState:UIControlStateHighlighted];
