...
- (void)_buildUI {
    ...
    [backButton setImage:@"FJAllMediaPreviewViewController.nav_back_w".zz_image forState:UIControlStateNormal];
    [backButton setImage:@"FJAllMediaPreviewViewController.nav_back_w".zz_image forState:UIControlStateHighlighted];
    ...
    [deleteButton setImage:@"FJAllMediaPreviewViewController.nav_delete_w".zz_image forState:UIControlStateNormal];
    [deleteButton setImage:@"FJAllMediaPreviewViewController.nav_delete_w".zz_image forState:UIControlStateHighlighted];
...
- (void)_checkVideo {
    ...
    /*
    FJMediaObject *media = [self.medias zz_arrayObjectAtIndex:self.page];
    if (media == nil) {
        return;
    }
