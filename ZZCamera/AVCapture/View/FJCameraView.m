...
- (void)_buildUI:(FJCaptureConfig *)config {
    ...
    if (self.config.enableSwitch) {
        ...
        if (self.config.widgetUsingImageTopView) {
            [switchCameraButton setImage:@"FJCameraView.ic_switch".zz_image forState:UIControlStateNormal];
        }else {
    ...
    if (self.config.enableLightSupplement) {
        ...
        if (self.config.widgetUsingImageTopView) {
            [lightButton setImage:@"FJCameraView.ic_torch_off".zz_image forState:UIControlStateNormal];
            [lightButton setImage:@"FJCameraView.ic_torch_on".zz_image forState:UIControlStateSelected];
        }else {
    ...
    if (self.config.enableFlashLight) {
        ...
        if (self.config.widgetUsingImageTopView) {
            [flashButton setImage:@"FJCameraView.ic_light_off".zz_image forState:UIControlStateNormal];
            [flashButton setImage:@"FJCameraView.ic_light_on".zz_image forState:UIControlStateSelected];
        }else {
    ...
    if (self.config.enableAutoFocusAndExposure) {
        ...
        if (self.config.widgetUsingImageTopView) {
            [focusAndExposureButton setImage:@"FJCameraView.ic_auto_focus_exposure".zz_image forState:UIControlStateNormal];
        }else {
