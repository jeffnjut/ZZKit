...
@interface ZZPhotoLibrarySelectionView ()
...
@implementation ZZPhotoLibrarySelectionView

- (void)awakeFromNib {
    
    [super awakeFromNib];
    self.arrowImage.image = @"ZZPhotoLibrarySelectionView.ic_arrow_down".zz_image;
}

+ (ZZPhotoLibrarySelectionView *)create:(NSString *)title {
    
    ZZPhotoLibrarySelectionView *view = ZZ_LOAD_NIB(@"ZZPhotoLibrarySelectionView");
...
- (IBAction)_tap:(UIButton *)sender {
    ...
    if (self.extended) {
        ...
        self.arrowImage.image = @"ZZPhotoLibrarySelectionView.ic_arrow_up".zz_image;
