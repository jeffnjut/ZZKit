//
//  ZZFlexibleCropperView.m
//  ZZKit
//

#import "ZZFlexibleCropperView.h"
...
typedef NS_ENUM(NSInteger, ZZFlexibleCropAreaCornerPosition) {
    ZZFlexibleCropAreaCornerPositionTopLeft,
    ZZFlexibleCropAreaCornerPositionTopRight,
    ZZFlexibleCropAreaCornerPositionBottomLeft,
    ZZFlexibleCropAreaCornerPositionBottomRight
};
typedef NS_ENUM(NSInteger, ZZFlexibleCropMidLineType) {
    
    ZZFlexibleCropMidLineTypeTop,
    ZZFlexibleCropMidLineTypeBottom,
    ZZFlexibleCropMidLineTypeLeft,
    ZZFlexibleCropMidLineTypeRight
...
@property (assign, nonatomic) ZZFlexibleCropAreaCornerPosition cornerPosition;
...
- (void)setCornerPosition:(ZZFlexibleCropAreaCornerPosition)cornerPosition {
...
- (void)drawCornerLines {
    ...
    switch (_cornerPosition) {
        case ZZFlexibleCropAreaCornerPositionTopLeft: {
        ...
        case ZZFlexibleCropAreaCornerPositionTopRight: {
        ...
        case ZZFlexibleCropAreaCornerPositionBottomLeft: {
        ...
        case ZZFlexibleCropAreaCornerPositionBottomRight: {
...
@property (strong, nonatomic) UIColor *lineColor;
@property (assign, nonatomic) ZZFlexibleCropMidLineType type;
@end
...
- (void)setType:(ZZFlexibleCropMidLineType)type {
...
- (void)drawMidLine {
    ...
    switch (_type) {
        case ZZFlexibleCropMidLineTypeTop:
        case ZZFlexibleCropMidLineTypeBottom: {
        ...
        case ZZFlexibleCropMidLineTypeRight:
        case ZZFlexibleCropMidLineTypeLeft: {
...
@end
@interface ZZFlexibleCropperView() {
...
@end
@implementation ZZFlexibleCropperView
...
- (void)createCorners {
    ...
    _topLeftCorner.cornerPosition = ZZFlexibleCropAreaCornerPositionTopLeft;
    ...
    _topRightCorner.cornerPosition = ZZFlexibleCropAreaCornerPositionTopRight;
    ...
    _bottomLeftCorner.cornerPosition = ZZFlexibleCropAreaCornerPositionBottomLeft;
    ...
    _bottomRightCorner.cornerPosition = ZZFlexibleCropAreaCornerPositionBottomRight;
...
- (void)createMidLines {
    ...
    _topMidLine.type = ZZFlexibleCropMidLineTypeTop;
    ...
    _bottomMidLine.type = ZZFlexibleCropMidLineTypeBottom;
    ...
    _leftMidLine.type = ZZFlexibleCropMidLineTypeLeft;
    ...
    _rightMidLine.type = ZZFlexibleCropMidLineTypeRight;
